...
@section('contenido')
<form class="container" method="POST" action="/Actualizar-Perdida/{{ $users->id }}" style="width: 50%;">
    {{ csrf_field()}}
    {{ method_field('PUT')}}
    <h1 style="text-align: center">REVISAR PERDIDA</h1>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="objeto" name="objeto" value="{{ $users->objeto}}" readonly>
    ...
    <div style="text-align:center;">
        ...
        <a href="/Ver_Perdidas" class="btn btn-danger">Cancelar</a>
    </div>
</form>
@endsection